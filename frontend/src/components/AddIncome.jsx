    ...
    try {
      ...
      if (confirmation.isConfirmed) {
        ...
        if(purpose==="Cash Deposit" || purpose==="Cash withdrawal"){
          await axios.post('https://pearlcrest.onrender.com/api/v1/account/add-admin-income', {
          mode: mode,
          amount: amount,
          purpose: purpose,
        ...
        .then(response => {
          ...
          await axios.post('https://pearlcrest.onrender.com/api/v1/account/add-admin-transaction', {
          mode: mode,
          amount: amount,
          purpose: purpose,
          months: months,
