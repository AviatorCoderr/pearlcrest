...
export default function BankBook() {
    ...
    const generateExcel = () => {
        ...
        const worksheet = workbook.addWorksheet('BankBook');
        ...
        workbook.xlsx.writeBuffer().then((buffer) => {
            ...
            a.href = url;
            a.download = `Bankbook_${new Date().toISOString().split('T')[0]}.xlsx`;
            a.click();
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">All Bank receipts</p>
                            </div>
                    ...
                    <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">All Bank payments</p>
                            </div>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Current Bank position</p>
                            </div>
