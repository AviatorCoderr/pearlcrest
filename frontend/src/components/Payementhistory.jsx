...
export default function PaymentHistory() {
    ...
    const getTrans = async() => {
        const response = await axios.get("https://pearlcrest.onrender.com/api/v1/account/get-transaction", {withCredentials: true})
        const user = await axios.get("https://pearlcrest.onrender.com/api/v1/users/get-current-user", {withCredentials: true})
